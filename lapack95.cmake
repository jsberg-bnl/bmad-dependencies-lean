...
if(EXISTS "${lapack_LIBRARY_DIRS}/liblapack.so")
  execute_process(COMMAND nm -D ${lapack_LIBRARY_DIRS}/liblapack.so OUTPUT_VARIABLE lapack_syms)
elseif(EXISTS "$(lapack_LIBRARY_DIRS)/liblapack.dylib")
  execute_process(COMMAND nm -g -U ${lapack_LIBRARY_DIRS}/liblapack.dylib OUTPUT_VARIABLE lapack_syms)
else()
