...
if(EXISTS "${lapack_LIBDIR}/liblapack.so")
  execute_process(COMMAND nm -D ${lapack_LIBDIR}/liblapack.so OUTPUT_VARIABLE lapack_syms)
elseif(EXISTS "$(lapack_LIBDIR)/liblapack.dylib")
  execute_process(COMMAND nm -g -U ${lapack_LIBDIR}/liblapack.dylib OUTPUT_VARIABLE lapack_syms)
else()
